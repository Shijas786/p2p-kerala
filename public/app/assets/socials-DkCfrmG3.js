import{c as I,n as W,D as l,a as O,i as _,s as S,ak as h,aC as T,R as f,p as F,b as c,aD as D,l as C,aE as N,A as j,aF as A,z as $,k as d,C as P,aG as M,E as u,aH as U,S as v,aI as z,aA as R,T as x}from"./index-Cycn2SnR.js";const q=I`
  :host {
...
`;var k=function(t,e,o,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,o):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,o,r);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(i=(n<3?s(i):n>3?s(e,o,i):s(e,o))||i);return n>3&&i&&Object.defineProperty(e,o,i),i};let L=class extends _{constructor(){super(),this.unsubscribe=[],this.checked=A.state.isLegalCheckboxChecked,this.unsubscribe.push(A.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var E;const{termsConditionsUrl:e,privacyPolicyUrl:o}=h.state,r=(E=h.state.features)==null?void 0:E.legalCheckbox,s=!!(e||o)&&!!r&&!this.checked,a=s?-1:void 0;return c`
    ...
    `}};L.styles=G;k([l()],L.prototype,"checked",void 0);L=k([O("w3m-connect-socials-view")],L);const B=I`
  wui-logo {
    width: 80px;
    height: 80px;
