import{aA as k,b9 as le,R as c,C as pe,c as v,r as V,a as f,i as g,b as d,n as l,z as $,A as H,D as u,e as me,k as w,v as B,y as U,b5 as fe,aG as F,E as K,ak as A,s as M,g as we,S as E,aC as z,b2 as oe,T as be,U as ce,ba as ge,bb as ye}from"./index-Cd2Tu6z-.js";import{P as D}from"./index-Ds9C9yvC.js";import{S as ve}from"./SwapController-B2pQz8YR.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
