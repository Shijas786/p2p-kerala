import{cF as A,df as l,cI as w,cJ as D,cK as C,c_ as $,cR as h,cL as u,d4 as V,cX as N,cT as S,d0 as K,dW as M,cY as F,cZ as Q,cG as W,cH as H,ei as _}from"./index-CmnP8RuI.js";import{S as s}from"./SwapController-BwQ0iwIW.js";import"./index-myaa4IOI.js";const q={numericInputKeyDown(e,t,o){const i=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],r=e.metaKey||e.ctrlKey,n=e.key,a=n.toLocaleLowerCase(),c=a==="a",b=a==="c",I=a==="v",U=a==="x",E=n===",",R=n===".",B=n>="0"&&n<="9";!r&&(c||b||I||U)&&e.preventDefault(),t==="0"&&!E&&!R&&n==="0"&&e.preventDefault(),t==="0"&&B&&(o(n),e.preventDefault()),(E||R)&&(t||(o("0."),e.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&e.preventDefault()),!B&&!i.includes(n)&&!R&&!E&&e.preventDefault()}},G=A`
  :host {
    width: 100%;
  }
