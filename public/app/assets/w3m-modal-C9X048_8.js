import{dW as k,el as le,cT as c,cV as pe,cF as v,cG as V,cJ as f,cK as g,cL as d,cI as l,de as $,d2 as H,df as u,cH as me,c_ as w,cN as B,dc as U,eh as fe,e0 as F,cX as K,dQ as A,d6 as M,cQ as we,cU as E,dY as z,ee as oe,dd as be,cP as ce,em as ge,en as ye}from"./index-CEVWBIYY.js";import{P as D}from"./index-CU73pRuA.js";import{S as ve}from"./SwapController-DV7bhRuY.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
