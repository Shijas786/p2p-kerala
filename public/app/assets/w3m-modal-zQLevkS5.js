import{av as k,b4 as le,R as c,C as pe,c as v,r as V,a as f,i as g,b as d,n as l,z as $,A as H,D as u,e as me,k as w,v as B,y as U,b0 as fe,aB as F,E as K,ap as A,s as M,g as we,S as E,ax as z,aZ as oe,T as be,U as ce,b5 as ge,b6 as ye}from"./index-VwH_1DTO.js";import{P as D}from"./index-CeCi9lVj.js";import{S as ve}from"./SwapController-DIRaflu7.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
