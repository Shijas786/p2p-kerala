...
function playFlow(flow) {
  ...
  if (flow === 'buy' || flow === 'sell') {
    ...
    demoTimeouts.push(setTimeout(() => {
      ...
      demoTimeouts.push(setTimeout(() => { amt.classList.add('typing'); note.classList.remove('typing'); }, 1100));
      ...
      demoTimeouts.push(setTimeout(() => { scrollArea.scrollTop = 200; c2.style.transform = 'translate(150px, 330px)'; }, 2200));
      demoTimeouts.push(setTimeout(() => { note.classList.add('typing'); }, 2500));
      demoTimeouts.push(setTimeout(() => { note.innerText = "Erupee only"; }, 2800));
      demoTimeouts.push(setTimeout(() => { note.innerText = "Erupee only 📍"; note.classList.remove('typing'); }, 3000));
      
      // Click Publish
      demoTimeouts.push(setTimeout(() => { scrollArea.scrollTop = 300; c2.style.transform = 'translate(150px, 450px)'; }, 3400));
      demoTimeouts.push(setTimeout(() => { pub.classList.add('btn-clicked'); }, 4000));
      demoTimeouts.push(setTimeout(() => { c2.style.opacity = '0'; }, 4100));
    ...
    // Click Sign
    demoTimeouts.push(setTimeout(() => { btnMmSign.classList.add('btn-clicked'); }, 4800));
...
console.log("No Details Missed UI Built.");
