...
.ma-btn { margin: 2rem 1rem; padding: 1rem; border-radius: 8px; font-weight: 700; font-size: 0.95rem; text-align: center; transition: transform 0.1s; }
  ...
  if (flow === 'buy' || flow === 'sell') {
    ...
    screen.innerHTML = notch + \`
      ...
      <div class="ma-content" id="form-scroll">
        ...
        <div id="ad-list">
          <!-- Ads will be injected here later -->
        </div>
    ...
    demoTimeouts.push(setTimeout(() => {
      scrollArea.innerHTML = \`
        ...
        <div class="ma-input" style="padding:0; border:none; background:transparent;">
          <div class="ma-chip active" style="flex:1; text-align:center; border-radius:8px;">Base</div>
          <div class="ma-chip" style="flex:1; text-align:center; border-radius:8px;">BSC</div>
        </div>
        
        <div class="ma-label">3. TOKEN</div>
        <div class="ma-input" style="padding:0; border:none; background:transparent;">
          <div class="ma-chip active" style="flex:1; text-align:center; border-radius:8px; background:var(--ma-green); color:#000; border:none;">USDC</div>
          <div class="ma-chip" style="flex:1; text-align:center; border-radius:8px;">USDT</div>
        </div>
      ...
      demoTimeouts.push(setTimeout(() => { c.style.opacity = '1'; c.style.transform = 'translate(150px, 420px)'; }, 1000));
      ...
      demoTimeouts.push(setTimeout(() => {
        ...
        demoTimeouts.push(setTimeout(() => { amt.innerText = "2"; }, 2500));
        demoTimeouts.push(setTimeout(() => { amt.innerText = "25"; }, 2800));
        demoTimeouts.push(setTimeout(() => { amt.innerText = "25.08"; amt.classList.remove('typing'); }, 3100));
        
        // Scroll down for Note
        demoTimeouts.push(setTimeout(() => { scrollArea.scrollTop = 250; c.style.transform = 'translate(150px, 350px)'; }, 4000));
        demoTimeouts.push(setTimeout(() => { note.classList.add('typing'); }, 4800));
        demoTimeouts.push(setTimeout(() => { note.innerText = "Erupee only"; }, 5200));
        demoTimeouts.push(setTimeout(() => { note.innerText = "Erupee only 📍"; note.classList.remove('typing'); }, 5600));
        
        // Click Publish
        demoTimeouts.push(setTimeout(() => { scrollArea.scrollTop = 400; c.style.transform = 'translate(150px, 480px)'; }, 6500));
        demoTimeouts.push(setTimeout(() => { pub.classList.add('btn-clicked'); }, 7500));
        demoTimeouts.push(setTimeout(() => { c.style.opacity = '0'; }, 7700));

        // RETURN TO MY ADS (Step 3)
        demoTimeouts.push(setTimeout(() => {
          scrollArea.innerHTML = \`
            <div class="ma-header"><div class="ma-title">My Ads</div></div>
            <div class="ma-tabs">
              <div class="ma-tab active">Active (1)</div>
              <div class="ma-tab">History</div>
            </div>
            <div id="ad-list">
              <div class="ad-card">
                <div class="ad-header">
                  <div class="ad-type"><div class="ad-badge \${isBuy ? 'buy' : 'sell'}">\${activeText}</div> USDC</div>
                  <div class="ad-status">ACTIVE</div>
                </div>
                <div class="ad-price">₹\${isBuy ? '98.00' : '98.50'} <span>/USDC</span></div>
        ...
        demoTimeouts.push(setTimeout(() => { 
                ...
                <div class="tg-msg">
                  <div class="tg-msg-inner">
                    ...
                    <div class="tg-msg-text">
                      ...
                      \${isBuy ? '🟢 @Medphysicist wants to buy' : '🔴 @pcoke_og wants to sell'} <b>25.08 USDC</b><br/>
                      💰 Rate: ₹\${isBuy ? '98' : '98.5'}/USDC<br/>
          ...
          \`;
        }, 11000)); // Waits 3 seconds on My Ads screen
    ...
    screen.innerHTML = notch + \`
      ...
      <div class="ma-modal" id="modal" style="display:none; opacity:0;">
        <div class="ma-modal-content">
          ...
          <div class="ma-row" style="padding:0; margin-bottom:1.5rem;"><div class="ma-chip active">USDT</div><div class="ma-chip">USDC</div></div>
    ...
    demoTimeouts.push(setTimeout(() => { vamt.innerText = "5"; }, 4500));
    demoTimeouts.push(setTimeout(() => { vamt.innerText = "50"; }, 4800));
    demoTimeouts.push(setTimeout(() => { vamt.innerText = "500"; vamt.classList.remove('typing'); }, 5100));
    
    demoTimeouts.push(setTimeout(() => { c.style.transform = 'translate(150px, 500px)'; }, 6000));
    demoTimeouts.push(setTimeout(() => { conf.classList.add('btn-clicked'); }, 7200));
    ...
    demoTimeouts.push(setTimeout(() => { btnMmSign.classList.add('btn-clicked'); }, 9500));
...
console.log("Final Final Exact Sequence Built.");
